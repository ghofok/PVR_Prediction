...
% Imput data driven "Decision Tree" classifier on feature set 1 for PVR prediciton and test the proposed
...
inputTable = PVR5;
features = {'AGELACHIRURGIE', 'DURESYMPTOMESJOURS', 'MACULA', 'DRTOTAL', 'DECHIRUREGANTE', 'TO', 'HBVITRE', 'PVRPREEXISTANT'};

%% Optimized Naive Bayes classifier (Feature set 2 / Model 2)

% Imput data driven "Optimized Naive Bayes " classifier on feature set 2 for PVR prediciton and test the proposed
...
X = features;
Y = output;
isCategoricalPredictor = [false, false, true, true, true, false, true];
